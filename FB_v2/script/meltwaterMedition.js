        ...
        if(v < 2){
            if(v == 0){ 
                ...
                if(pos < 1 ){
                    ...
                    let html_text='<html><head><title>Mediciones</title><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous"><script src="https://cdn.jsdelivr.net/npm/apexcharts"></script><style>#containerChart{height:400px;width:100%}.tooltip-chart{border:solid #008ffb;padding:10px;border-radius:10px}</style></head><body style="overflow-x:hidden;margin:0px;font-family:arial"><div class="row" style="background:#f2f2f2"><div class="col-2 col-md-2"><img src="https://mwgroup.agency/LogoMW.png" style="width:100px"/></div><div class="col-10 col-md-8 text-center" style="padding-top:24px"><span style="font-size:26px;color:#004169"><b>{{title}}</b></span></div><div class="col-12 col-md-2"></div></div><br /><div class="container"><div class="row"><div class="col-12 col-md-6"><b>Alcance Potencial en Twitter y Facebook:</b> {{alcance}} </div><div class="col-12 col-md-3"><b>Post en Twitter:</b> {{twitter}} </div><div class="col-12 col-md-3"><b>Post en Facebook:</b> {{Facebook}} </div></div><br/><div class="row"><div class="col-12"><b>Algunos medios que han retomado la noticia son </b><br><p style="padding-right:20px">{{sh}}</p></div></div><br/><div class="row"><div class="col-12"><div id="containerChart"></div></div></div></div><br><br><script>let options={ "chart":{ "height":380, "width":"100%", "type":"area" }, "series":[ { "name":"Data", "data":{{dataXY}} } ], "xaxis":{ "type":"datetime" }, "dataLabels":{ "enabled":false }, "title":{ "text":"", "align":"left" }, "legend":{ "horizontalAlign":"left" }, "labels":{{dataLabels}}, "tooltip":{ "custom":function({series, seriesIndex, dataPointIndex, w}) { var data = w.globals.initialSeries[seriesIndex].data[dataPointIndex]; var myDate = new Date(data.x); let time = myDate.toLocaleString().split(",")[1]; var year = myDate.toLocaleString("default", { year: "numeric" }); var month = myDate.toLocaleString("default", { month: "2-digit" }); var day = myDate.toLocaleString("default", { day: "2-digit" }); var formattedDate = day + "-" + month+"-"+year; return "<div class=\'tooltip-chart\'> <span><b>Fecha</b>: " + formattedDate + "</span></br><span><b>Conteo</b>: " + data.y.toLocaleString(\'en-US\', {maximumFractionDigits:2}) + "</span><div>"; } } };var chart = new ApexCharts(document.querySelector("#containerChart"), options);chart.render();</script></body><footer style="background:#004169;color:#FFFF;bottom:0;width:100%;height:6rem"><div style="display:flex;padding:20px"><div style="width:50%;font-size:18px;padding-left:20px"> Copyright © 2023. All rights reserved. </div><div style="width:50%;font-size:18px;text-align:right;padding-right:20px"><ul style="list-style-type:none;display:inline"><li style="color:#ffffff;display:inline"><a href="https://twitter.com/MWGroup_Mx"><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" style="color:white"><path d="M22.23,5.924c-0.736,0.326-1.527,0.547-2.357,0.646c0.847-0.508,1.498-1.312,1.804-2.27 c-0.793,0.47-1.671,0.812-2.606,0.996C18.324,4.498,17.257,4,16.077,4c-2.266,0-4.103,1.837-4.103,4.103 c0,0.322,0.036,0.635,0.106,0.935C8.67,8.867,5.647,7.234,3.623,4.751C3.27,5.357,3.067,6.062,3.067,6.814 c0,1.424,0.724,2.679,1.825,3.415c-0.673-0.021-1.305-0.206-1.859-0.513c0,0.017,0,0.034,0,0.052c0,1.988,1.414,3.647,3.292,4.023 c-0.344,0.094-0.707,0.144-1.081,0.144c-0.264,0-0.521-0.026-0.772-0.074c0.522,1.63,2.038,2.816,3.833,2.85 c-1.404,1.1-3.174,1.756-5.096,1.756c-0.331,0-0.658-0.019-0.979-0.057c1.816,1.164,3.973,1.843,6.29,1.843 c7.547,0,11.675-6.252,11.675-11.675c0-0.178-0.004-0.355-0.012-0.531C20.985,7.47,21.68,6.747,22.23,5.924z"></path></svg></a></li><li style="color:#ffffff;display:inline"><a href="https://www.linkedin.com/company/mw-groupmx/"><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" style="color:white"><path d="M19.7,3H4.3C3.582,3,3,3.582,3,4.3v15.4C3,20.418,3.582,21,4.3,21h15.4c0.718,0,1.3-0.582,1.3-1.3V4.3 C21,3.582,20.418,3,19.7,3z M8.339,18.338H5.667v-8.59h2.672V18.338z M7.004,8.574c-0.857,0-1.549-0.694-1.549-1.548 c0-0.855,0.691-1.548,1.549-1.548c0.854,0,1.547,0.694,1.547,1.548C8.551,7.881,7.858,8.574,7.004,8.574z M18.339,18.338h-2.669 v-4.177c0-0.996-0.017-2.278-1.387-2.278c-1.389,0-1.601,1.086-1.601,2.206v4.249h-2.667v-8.59h2.559v1.174h0.037 c0.356-0.675,1.227-1.387,2.526-1.387c2.703,0,3.203,1.779,3.203,4.092V18.338z"></path></svg></a></li></ul></div></div></footer></html>';
                        //html_text = html_text.replace("{{grafica}}",reqMeltSearchmwm.objectResult[0].dataChart)//graficamentionstrend)
                        html_text = html_text.replace("{{dataXY}}",JSON.stringify(reqMeltSearchmwm.objectResult[0].dataChart.series[0].data))//graficamentionstrend)
                        .replace("{{dataLabels}}", JSON.stringify(reqMeltSearchmwm.objectResult[0].dataChart.labels))
    ...
    if(!fileOK){
        ...
        for (let optLa of document.getElementById('languajemwm').options)
        {
            if (optLa.selected) {
                ...
                _filters.languaje.push(optLa.value.toLowerCase());   
            }
        }
        for (let optLo of document.getElementById('locationmwm').options)
        {
            if (optLo.selected) {
                ...
                _filters.locations.push(optLo.value.toLowerCase());
            }
        }
        let ff = $("#dtEndmwm").val();
        ...
        if(dateIsOK){
            ...
            if(title != "" && s!= ""){
                ...
                try {
                    ...
                    _filters.dateStart = new Date(parseInt(msearchs.FECHA_INICIO.split("/")[2]),parseInt(msearchs.FECHA_INICIO.split("/")[1])-1, parseInt(msearchs.FECHA_INICIO.split("/")[0]) , 1, 0, 0, 0).getTime();
                    _filters.dateEnd = new Date(parseInt(msearchs.FECHA_FIN.split("/")[2]),parseInt(msearchs.FECHA_FIN.split("/")[1])-1, parseInt(msearchs.FECHA_FIN.split("/")[0]) , 23, 59, 59, 0).getTime();
...
function generateChart(responseSearch){
    let dataChart = responseSearch["AF-mentionsStatsTrendPredictive"].compoundWidgetData["AF-latestActivityPredictive"];
    let dt=[];
    let labelsDt = [];
    for(let d = 0; d < dataChart.data.length; d++){
        dt.push({x:parseInt(dataChart.data[d].key), y:parseInt(dataChart.data[d].value)});
        labelsDt.push(parseInt(dataChart.data[d].key));
    }
        ...
        tooltip: {
            custom: function({series, seriesIndex, dataPointIndex, w}) {
                var data = w.globals.initialSeries[seriesIndex].data[dataPointIndex];
                    ...
                    var myDate = new Date(data.x);
                    let time = myDate.toLocaleString().split(",")[1];
                    var year = myDate.toLocaleString("default", { year: "numeric" });
                    var month = myDate.toLocaleString("default", { month: "2-digit" });
                    var day = myDate.toLocaleString("default", { day: "2-digit" });
...
function injectScriptMWM(_search, _mctrlsToFind, _mctrlLanguajeFilter, _mctrlLocationFilter, _mdataFilters, _filterDate,max_authors) {
    ...
    console.log("mctrlsFilterDate: "+mctrlsFilterDate);

    
    let epochUTCFrom = Date.UTC(parseInt(search.FECHA_INICIO.split("/")[2]),parseInt(search.FECHA_INICIO.split("/")[1])-1, parseInt(search.FECHA_INICIO.split("/")[0]) , 7, 0, 0, 0);
    let epochUTCTo = Date.UTC(parseInt(search.FECHA_FIN.split("/")[2]),parseInt(search.FECHA_FIN.split("/")[1])-1, parseInt(search.FECHA_FIN.split("/")[0]) , 7, 0, 0, 0);
    for (let index = 0; index < mctrlsFilterDate.length; index++) {
        if(mctrlsFilterDate[index].name == "btn_day_from"){
            mctrlsFilterDate[index].attr = mctrlsFilterDate[index].attr.replace("epochUTCFrom",epochUTCFrom);
        }else if(mctrlsFilterDate[index].name == "btn_day_to"){
            mctrlsFilterDate[index].attr = mctrlsFilterDate[index].attr.replace("epochUTCTo",epochUTCTo);
        }
        
    }
    console.log("mctrlsFilterDate Actualizado: "+mctrlsFilterDate);
    console.log(mctrlsFilterDate);
    htmlFather ="";
    isInHtmlFather ="";
            ...
            if(v == 1){ 
                ...
                && search.FECHA_FIN != "" && search.FECHA_FIN !== undefined)){
                    ...
                    if(stepFilterDate.date > stepFilterDate.dates.length || stepFilterDate.maxclick <= 0){                        
                        ...
                        //console.log("Procesando stepFilterDate.step "+stepFilterDate.step);
                        if(stepFilterDate.step ==1){
                            for (let index = 0; index < mctrlsFilterDate.length; index++) {
                                if(mctrlsFilterDate[index].name=="btn_display_selector" ){
                                    console.log("Buscando el control de btn_display_selector ")
                                    pos = index;
                                    indexCtrl = index;
                                    break;
                                }
                        ...
                        if(stepFilterDate.step ==2){
                             for (let index = 0; index < mctrlsFilterDate.length; index++) {
                                 if(mctrlsFilterDate[index].name=="btn_custom" ){
                                    console.log("Buscando el control de btn_custom ")
                                     pos = index;
                                     indexCtrl = index;
                                     break;
                                 }
                            ...
                            /**
                             * 1.- Obtener el epoch para la fecha de inicio y fin con la siguiente funcion Date.UTC(2023,9, 30 , 7, 0, 0, 0);
                             * 2.- Identificar los click hacia atras y los clicks hacia adelante
                             * 3.- accionar los click                              * 
                             */
                            //search.FECHA_INICIO 23/10/2023
                            
                            let yn = dateNowProcess.getFullYear();
                            let mn = dateNowProcess.getMonth();
                            clicksBack = 0;
                            let ydif = yn - parseInt(search.FECHA_INICIO.split("/")[2]);
                            let mdif = mn - (parseInt(search.FECHA_INICIO.split("/")[1])-1);
                            if(ydif > 0){
                                clicksBack = (ydif*12)+mdif;
                            }else{
                                clicksBack = mdif;
                            }

                            for (let index = 0; index < mctrlsFilterDate.length; index++) {
                                if(mctrlsFilterDate[index].name=="btn_back_month" ){
                                   console.log("Buscando el control de btn_back_month ")
                                    pos = index;
                                    indexCtrl = index;
                                    break;
                                }
                         ...
                         processCtrlsRMW(mctrlsToFind, false);
                            ...
                            let mn = dateNowProcess.getMonth();
                            clicksNext = 0;
                            let ydif = yn - parseInt(search.FECHA_FIN.split("/")[2]);
                            let mdif = mn - (parseInt(search.FECHA_FIN.split("/")[1])-1);
                            if(ydif > 0){
                                clicksNext = clicksBack - ((ydif*12)+mdif);
                            }else{
                                clicksNext = clicksBack - mdif;
                            }

                            for (let index = 0; index < mctrlsFilterDate.length; index++) {
                                if(mctrlsFilterDate[index].name=="btn_next_month" ){
                                   console.log("Buscando el control de btn_next_month ")
                                    pos = index;
                                    indexCtrl = index;
                                    break;
                                }
                            }
                            stepFilterDate.step =6;
                            flag.setValue(-1);
                            processCtrlsRMW(mctrlsToFind, false);
                         
                        }
                        else if(stepFilterDate.step == 6){
                            for (let index = 0; index < mctrlsFilterDate.length; index++) {
                                let typeDate = stepFilterDate.dates[stepFilterDate.date];
                                                               
                                if(mctrlsFilterDate[index].name== "btn_day_to" ){
                                    pos = index;
                                    indexCtrl = index;
                                    break;
                                }
                            }
                            stepFilterDate.step =7;
                            flag.setValue(-1);
                            processCtrlsRMW(mctrlsToFind, false);
                        }
                        else if(stepFilterDate.step == 7){
                            for (let index = 0; index < mctrlsFilterDate.length; index++) {
                                let typeDate = stepFilterDate.dates[stepFilterDate.date];
                                                               
                                if(mctrlsFilterDate[index].name== "btn_apply_dates" ){
                                    pos = index;
                                    indexCtrl = index;
                                    break;
                                }
                            }
                            stepFilterDate.step =8;
                            flag.setValue(-1);
                            processCtrlsRMW(mctrlsToFind, false);
                        }else if(stepFilterDate.step == 8){
                            
                            stepFilterDate.date = 3;
                            stepFilterDate.step =-1;
                            inFilterDate = false;
                            stepFilterDate.finish = true;
                            indexCtrl = -1;
            ...
            if (!finded) {
                if (shadow != null) {
                    ...
                    for (let c = 0; c < children.length; c++) {
                        ...
                        if (ctrlToFind.tagName.toLowerCase() == "flux-tab"){
                            console.log("Es un flux-tab");
                            console.log(children[c].localName);
                        }
        ...
        if(_ctrl.action != "" && _ctrl.action !== undefined){
            ...
            for(let a = 0; a< actions.length; a++){
                ...
                if(actions[a].trim() == "click"){
                    ...
                    console.log(_ctrl);
                    if(_ctrl.name== "btn_next_month"){

                        if(clicksNext==0){
                            console.log("No hay clicks por hacer")
                            flag.setValue(-1);
                            flag.setValue(1);
                        }
                        for (let clk = 1; clk <= clicksNext; clk++) {    
                            if(clk==clicksNext){
                                _ctrl.finded.click();   
                                sleepRMW(_ctrl);
                            } else{                    
                                ...
                                setTimeout(function(){                                 
                                    _ctrl.finded.click();    
                                    console.log("click  "+clk+" accionado para el control "+_ctrl.name);
                                }, second);
                            }                               
                        }
                    }
                    else if(_ctrl.name== "btn_back_month"){
                        if(clicksNext==0){
                            console.log("No hay clicks por hacer")
                            flag.setValue(-1);
                            flag.setValue(1);
                        }
                        for (let clk = 1; clk <= clicksBack; clk++) {
                            if(clicksBack==clk){
                                _ctrl.finded.click();   
                                sleepRMW(_ctrl);
                            } else{                    
                        ...
                        console.log("click accionado para el control "+_ctrl.name);
                        let second = 3000;
                        setTimeout(function(){                                                             
                            console.log("accionado para el control "+_ctrl.name);
                            _ctrl.finded.click();   
                            sleepRMW(_ctrl);
                        }, second);
